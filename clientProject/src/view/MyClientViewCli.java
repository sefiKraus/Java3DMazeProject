...
public class MyClientViewCli extends CommonClassView implements Observer,ClientView {
	 CLI cli;
	 private String command;
	 
	 public MyClientViewCli() {
	 this.cli=new CLI(new BufferedReader(new InputStreamReader(System.in)), new PrintWriter(System.out));
	 this.cli.addObserver((Observer) this);
	 }
